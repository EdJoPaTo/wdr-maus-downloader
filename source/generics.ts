...
export function matchAll(
  ...
  text: string,
): ReadonlyArray<Readonly<RegExpExecArray>> {
...
export async function sequentialAsync<Argument, ReturnType>(
  func: (argument: Argument, index: number) => Promise<ReturnType>,
  missions: readonly Argument[],
): Promise<readonly ReturnType[]> {
